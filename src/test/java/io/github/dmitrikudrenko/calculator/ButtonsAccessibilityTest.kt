...
class ButtonsAccessibilityTest : CalculatorAbstractTest() {
    ...
    fun `zero button should be displayed and enabled`() {
        calculatorScreen.zeroBtn.shouldBeDisplayedAndEnabled().shouldHaveText("0")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `one button should be displayed and enabled`() {
        calculatorScreen.oneBtn.shouldBeDisplayedAndEnabled().shouldHaveText("1")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `two button should be displayed and enabled`() {
        calculatorScreen.twoBtn.shouldBeDisplayedAndEnabled().shouldHaveText("2")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `three button should be displayed and enabled`() {
        calculatorScreen.threeBtn.shouldBeDisplayedAndEnabled().shouldHaveText("3")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `four button should be displayed and enabled`() {
        calculatorScreen.fourBtn.shouldBeDisplayedAndEnabled().shouldHaveText("4")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `five button should be displayed and enabled`() {
        calculatorScreen.fiveBtn.shouldBeDisplayedAndEnabled().shouldHaveText("5")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `six button should be displayed and enabled`() {
        calculatorScreen.sixBtn.shouldBeDisplayedAndEnabled().shouldHaveText("6")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `seven button should be displayed and enabled`() {
        calculatorScreen.sevenBtn.shouldBeDisplayedAndEnabled().shouldHaveText("7")
    }

    @Test(groups = arrayOf("digits_accessibility"))
    fun `eight button should be displayed and enabled`() {
        calculatorScreen.eightBtn.shouldBeDisplayedAndEnabled().shouldHaveText("8")
    }
